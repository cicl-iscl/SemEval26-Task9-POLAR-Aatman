...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler("finetune_xlm_roberta.log", mode="w"),
    ],
)
logger = logging.getLogger(__name__)

def parse_args():
    parser = argparse.ArgumentParser(description="Finetune XLM-RoBERTa-large on Subtask 1")
    parser.add_argument("--model_name", type=str, default="FacebookAI/xlm-roberta-large", help="Model name or path")
    parser.add_argument("--data_dir", type=str, default="../../../data/subtask1", help="Path to data directory")
    parser.add_argument("--output_dir", type=str, default="./finetune_results_xlm_roberta", help="Output directory for results")
    parser.add_argument("--submission_dir", type=str, default="./subtask_1_xlm_roberta", help="Directory for submission files")
...
def main():
    ...
    shutil.make_archive("subtask_1_xlm_roberta", "zip", submission_dir)
    logger.info(f"Created subtask_1_xlm_roberta.zip in {os.getcwd()}")
